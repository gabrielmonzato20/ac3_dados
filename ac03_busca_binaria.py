...
truncada (isto é, arredondada para baixo) entre dois valores. Estes valores 
são indicados pelos seus nomes e nos comentários.

Preencha corretamente as três variáveis.
'''

media_4_6 = (4+6)//2    # preencher com a média TRUNCADA entre 4 e 6
media_1220_8 = (1220+8)//2# preencher com a média TRUNCADA entre 1220 e 8
media_7_20 = (7+20)//2   # preencher com a média TRUNCADA entre 7 e 20
...
prox_lado1 = 'direita'   # preencher com 'esquerda' ou 'direita'

# Agora no meio da lista encontrei o 71. (Estou buscando 50)
prox_lado2 = 'esquerda'   # preencher com 'esquerda' ou 'direita'

# Agora no meio da lista encontrei o 44. (Estou buscando 50)
prox_lado3 = 'direita'   # preencher com 'esquerda' ou 'direita'
...
o índice do meio e o elemento que nele se encontra.
'''
...
class TestStringMethods(unittest.TestCase):
    ...
    def test_001_var_posicao_36(self):
        self.compara_hash(posicao_36, 6)
        
    def test_002_var_posicao_111(self):
        self.compara_hash(posicao_111, None)

    def test_003_var_posicao_127(self):
        self.compara_hash(posicao_127, 11)

    def test_004_na_posicao(self):
    ...
    def test_005_busca_linear(self):
        lista = list(range(0, 100))
    ...
    def test_006_busca_linear_fotografias(self): 
        reseta_fotos()
    ...
    def test_007_var_medias(self):
        self.compara_hash(media_4_6, 5)
        self.compara_hash(media_1220_8, 614)
        self.compara_hash(media_7_20, 13)

    def test_008_media(self):
    ...
    def test_010_var_prox_lado(self):
        _esq = 'esquerda'
        _dir = 'direita'
    ...
    def test_011_busca_funciona(self):
    ...
    def test_012_busca_binaria_fotos(self):
        reseta_fotos()
...
# para rodar a versão "rápida", que só vai até o primeiro teste que falhar,
# use a linha abaixo:
